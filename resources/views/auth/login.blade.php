...
<link type="text/css" rel="stylesheet" href="{{ asset('plantilla/AdminLTE/dist/css/AdminLTE.min.css') }}  ">
        ...
        <link href="{{ asset('plantilla/AdminLTE/plugins/iCheck/square/blue.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="../../index2.html"><b>La</b>Auténtica</a><br>
                   <small>sistema de geolocalización</small>
            </div>         
            <!-- /.login-logo -->
